...
export const PROCESS_ZONES: ProcessZone[] = [
  ...
  },
  {
    ...
    lineType: 'BESS',
    machines: [
      { id: 'C.2.1.1', wbsCode: 'C.2.1.1', name: 'BESS Module Stacking & Compression Rig', description: 'Heavy-duty 52S high-voltage module compression & side plate laser riveting', cycleTimeSec: 180, machinesCount: 4, unitRateUSD: 95000, totalCostUSD: 380000, status: 'running', utilizationPct: 89 },
