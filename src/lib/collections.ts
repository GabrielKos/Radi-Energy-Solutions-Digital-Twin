...
export const useWarehouses = () => useSupabaseTable<WarehouseInfo>(warehouseAdapter);
...
export const useWorkforce = () => useSupabaseTable<PersonnelCategory>(workforceAdapter);
...
export const useTariffPeriods = () => useSupabaseTable<TariffPeriod>(tariffAdapter);
...
export const useCapexItems = () => useSupabaseTable<CapExItem>(capexAdapter);
...
export function useZonesWithMachines() {
  const zonesResult = useSupabaseTable(zoneShellAdapter);
  const machinesResult = useSupabaseTable(machineAdapter);
